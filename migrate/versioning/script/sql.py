    ...
    def run(self, engine, step=None):
        ...
        try:
            ...
            try:
                ...
                # by one
                # TODO(edgars): make this parametric, but for my scripts I don't want to strip spaces and comments
                text = sqlparse.format(text, strip_comments=False, strip_whitespace=False)
